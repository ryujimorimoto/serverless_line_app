...
import {AppProvider, TextStyle, ContextualSaveBar,InlineError,
    Frame, Layout, Page, SettingToggle, TopBar, Card,
    TextField, Form, FormLayout, Tabs, Button, Spinner, Toast } from '@shopify/polaris';
import {
  Redirect,
  useHistory,
...
export default function Verification(props) {
  ...
  //   cognito.confirmation(params.email, "1").then(()=>{},(e)=>{
  //     // verification_component(e.code);
  //     console.log(e.code)
  //   })
  // }
  ...
  const theme = {
    ...
    async function handleVerifySubmit(e) {
      ...
      cognito.confirmation(params.email, codeFieldValue).then(()=>{
        history.push("/sign_in?show=sign_in&flash=アカウント登録が完了しました")
      },(e)=>{
        verification_component(e.code);
      });
    }
